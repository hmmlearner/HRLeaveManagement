        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequestingEmpolyeeID = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DateCreated = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DateModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 7, 4, 21, 10, 34, 726, DateTimeKind.Local).AddTicks(8878), new DateTime(2023, 7, 4, 21, 10, 34, 726, DateTimeKind.Local).AddTicks(8927), 10, "Vacation" });
